...
/**
 * Servlet implementation class ReviewDeleteSearchServlet
 */
@WebServlet("/deleteSearch")
public class ReviewDeleteSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewDeleteSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result=service.deleteSearch(keyword);
